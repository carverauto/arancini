...
pub mod update {
    ...
    impl<'a> Reader<'a> {
        ...
        pub fn get_communities(
            self,
        ) -> ::capnp::Result<::capnp::struct_list::Reader<'a, crate::update_capnp::community::Owned>>
        {
            ::capnp::traits::FromPointerReader::get_from_pointer(
        ...
        #[inline]
        pub fn get_extended_communities(
            self,
        ) -> ::capnp::Result<
            ::capnp::struct_list::Reader<'a, crate::update_capnp::extended_community::Owned>,
        > {
            ::capnp::traits::FromPointerReader::get_from_pointer(
        ...
        #[inline]
        pub fn get_large_communities(
            self,
        ) -> ::capnp::Result<
            ::capnp::struct_list::Reader<'a, crate::update_capnp::large_community::Owned>,
        > {
            ::capnp::traits::FromPointerReader::get_from_pointer(
    ...
    impl<'a> Builder<'a> {
        ...
        pub fn get_communities(
            self,
        ) -> ::capnp::Result<::capnp::struct_list::Builder<'a, crate::update_capnp::community::Owned>>
        {
            ::capnp::traits::FromPointerBuilder::get_from_pointer(
        ...
        pub fn set_communities(
            &mut self,
            value: ::capnp::struct_list::Reader<'_, crate::update_capnp::community::Owned>,
        ) -> ::capnp::Result<()> {
            ::capnp::traits::SetterInput::set_pointer_builder(
        ...
        #[inline]
        pub fn init_communities(
            self,
            size: u32,
        ) -> ::capnp::struct_list::Builder<'a, crate::update_capnp::community::Owned> {
            ::capnp::traits::FromPointerBuilder::init_pointer(
                self.builder.get_pointer_field(6),
                size,
            )
        ...
        pub fn get_extended_communities(
            ...
            ::capnp::struct_list::Builder<'a, crate::update_capnp::extended_community::Owned>,
        > {
            ::capnp::traits::FromPointerBuilder::get_from_pointer(
        ...
        #[inline]
        pub fn set_extended_communities(
            &mut self,
            value: ::capnp::struct_list::Reader<'_, crate::update_capnp::extended_community::Owned>,
        ) -> ::capnp::Result<()> {
            ::capnp::traits::SetterInput::set_pointer_builder(
        ...
        #[inline]
        pub fn init_extended_communities(
            self,
            size: u32,
        ) -> ::capnp::struct_list::Builder<'a, crate::update_capnp::extended_community::Owned>
        {
        ...
        pub fn get_large_communities(
            ...
            ::capnp::struct_list::Builder<'a, crate::update_capnp::large_community::Owned>,
        > {
            ::capnp::traits::FromPointerBuilder::get_from_pointer(
        ...
        pub fn set_large_communities(
            &mut self,
            value: ::capnp::struct_list::Reader<'_, crate::update_capnp::large_community::Owned>,
        ) -> ::capnp::Result<()> {
            ::capnp::traits::SetterInput::set_pointer_builder(
    ...
    impl Pipeline {}
    mod _private {
        pub static ENCODED_NODE: [::capnp::Word; 531] = [
        ...
        pub static MEMBERS_BY_NAME: &[u16] = &[
            20, 21, 11, 14, 19, 26, 22, 23, 10, 9, 24, 17, 27, 28, 29, 30, 16, 15, 18, 13, 25, 4,
            6, 5, 7, 8, 2, 3, 12, 1, 0,
        ];
