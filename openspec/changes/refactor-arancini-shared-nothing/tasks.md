...
- [x] 2.6 Validate host tuning guidance and runtime socket option enforcement on Linux (`sysctl`, fd limits, backlog, RSS/IRQ guidance).
- [x] 2.8 Validate backlog and receive-buffer socket tuning under burst BMP table-dump scenarios.
